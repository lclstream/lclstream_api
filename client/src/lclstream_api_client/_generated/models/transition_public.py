...
class TransitionPublic(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "info", "source", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransitionPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransitionPublic from a dict"""
        if obj is None:
            return None
