...
class ProcessingPipeline(BaseModel):
    ...
    ProcessingPipeline
    """
    # data type: BatchProcessingPipelineParameters
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ProcessingPipeline.model_construct()
        error_messages = []
        match = 0
        # validate data type: BatchProcessingPipelineParameters
        if not isinstance(v, BatchProcessingPipelineParameters):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BatchProcessingPipelineParameters`")
        else:
            match += 1
        # validate data type: PeaknetPreprocessingPipelineParameters
        if not isinstance(v, PeaknetPreprocessingPipelineParameters):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into BatchProcessingPipelineParameters
        try:
            instance.actual_instance = BatchProcessingPipelineParameters.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PeaknetPreprocessingPipelineParameters
        try:
            instance.actual_instance = PeaknetPreprocessingPipelineParameters.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
