...
class TransferLogStreamInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["available", "modified_at", "path", "size", "stream"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferLogStreamInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferLogStreamInfo from a dict"""
        if obj is None:
            return None
